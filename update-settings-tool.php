...
public function widget( $args, $instance ) {	
	...
	switch ($instance['widget_name']) {
		...
		break;
		default:
			$widget_option_name = 'widget_same-category-posts';
			$widget_metas_name  = '';
...
public function form( $instance ) {
	...
	<p>
		...
		<select id="<?php echo $this->get_field_id("widget_name"); ?>" name="<?php echo $this->get_field_name("widget_name"); ?>">
			...
			<option value="same-cat-posts" <?php selected($widget_name, 'same-cat-posts')?>>Same Category Posts</option>
		</select>
	</p>
